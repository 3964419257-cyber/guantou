...
const EXTRA_FREE_THEMES = [
  ...
  freeTheme({
    ...
    blurb: '像一本茶印旧刊。茶褐实心键按下会弹，不改罐头播放。',
    category: 'retro',
    preview: 'retro',
    accent: 'tea',
    primaryLook: 'fill',
  ...
  freeTheme({
    ...
    blurb: '像一座夜网岗亭。青墨实心键带呼吸灯，不改罐头播放。',
    category: 'cyber',
    preview: 'cyber',
    accent: 'ink',
    primaryLook: 'fill',
  ...
  freeTheme({
    ...
    blurb: '像一张铜网讯号板。陶土墨色对比键带散光，不改罐头播放。',
    category: 'cyber',
    preview: 'cyber',
    accent: 'clay',
  ...
  freeTheme({
    ...
    blurb: '像一台茶褐终端。墨色对比键带呼吸灯，不改罐头播放。',
    category: 'cyber',
    preview: 'cyber',
    accent: 'tea',
    primaryLook: 'contrast',
  ...
  freeTheme({
    ...
    blurb: '像一盏茶摊灯。茶褐实心键带灯火光晕，不改罐头播放。',
    category: 'street',
    preview: 'street',
    accent: 'tea',
    primaryLook: 'fill',
  ...
  freeTheme({
    ...
    blurb: '像雾夜里的摊牌。雾青实心键带灯火光晕，不改罐头播放。',
    category: 'street',
    preview: 'street',
    accent: 'mist',
    primaryLook: 'fill',
  ...
  freeTheme({
    ...
    blurb: '像一圈浅底星符。桂金浅底键带呼吸灯，不改罐头播放。',
    category: 'anime',
    preview: 'anime',
    accent: 'osmanthus',
    primaryLook: 'soft',
  ...
  freeTheme({
    ...
    blurb: '像一座墨格广播亭。青墨清新键带呼吸灯，不改罐头播放。',
    category: 'anime',
    preview: 'anime',
    accent: 'ink',
    primaryLook: 'fresh',
  ...
  freeTheme({
    ...
    blurb: '像一页茶褐漫格。浅底古风键按下会弹，不改罐头播放。',
    category: 'anime',
    preview: 'anime',
    accent: 'tea',
    primaryLook: 'soft',
...
export const GLOBAL_THEMES = [
  {
    ...
    blurb: '乡野松绿实心键。会改导航栏、按钮、卡片、背景和文字色彩，带轻微纹理，不改罐头播放画面。',
    category: 'simple',
    preview: 'default',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像一张雾青便笺。浅底软按钮、淡雾描边，不改罐头播放。',
    category: 'simple',
    preview: 'simple',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像一场江南梅雨。整套换成雾青水墨、淡雾描边，不改罐头播放。',
    category: 'dialect',
    region: 'wuyu',
    preview: 'simple',
    available: true,
  ...
  },
  {
    ...
    blurb: '像走进岭南骑楼。陶土朱印键、浅光晕，不改罐头播放。',
    category: 'dialect',
    region: 'yue',
    preview: 'festival',
    available: true,
  ...
  },
  {
    ...
    blurb: '像闽南盐田午后。桂金实心键微微浮起，不改罐头播放。',
    category: 'dialect',
    region: 'minnan',
    preview: 'dialect',
    available: true,
  ...
  },
  {
    ...
    blurb: '像一份油印乡刊。整套换成茶褐古风栏线，字迹带晕墨，不改罐头播放。',
    category: 'retro',
    preview: 'retro',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像一页泡过茶的笺纸。茶褐细描边、素净留白，不改罐头播放。',
    category: 'retro',
    preview: 'retro',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像一间夜航播音室。深底青墨、金线描边、按钮带光晕，不改罐头播放。',
    category: 'cyber',
    preview: 'cyber',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像一座夜航讯号亭。雾青实心键带呼吸灯，不改罐头播放。',
    category: 'cyber',
    preview: 'cyber',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像一卷青绿山水。松绿细描边、水墨浅底，不改罐头播放。',
    category: 'guofeng',
    preview: 'guofeng',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像盖过朱印的宣纸。陶土方印键带浅光晕，不改罐头播放。',
    category: 'guofeng',
    preview: 'guofeng',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像巷口夜市灯牌。陶土实心键带灯火光晕，不改罐头播放。',
    category: 'street',
    preview: 'street',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像坐进一间茶馆。茶褐实心键、暖边微浮，不改罐头播放。',
    category: 'street',
    preview: 'street',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像桂花夜里的圆窗。整套换成桂金色金线按钮，不改罐头播放。',
    category: 'festival',
    preview: 'festival',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像岁夜里的一盏灯。陶土朱印键带散光，不改罐头播放。',
    category: 'festival',
    preview: 'festival',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像一座像素广播亭。雾青浅底按钮带呼吸灯，不改罐头播放。',
    category: 'anime',
    preview: 'anime',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像一页格子漫画。陶土实心键按下会弹，不改罐头播放。',
    category: 'anime',
    preview: 'anime',
    available: true,
    access: ACCESS_FREE,
  ...
  },
  {
    ...
    blurb: '像夜里的田野笔记。青墨深沉键、素净细线，不改罐头播放。',
    category: 'dark',
    preview: 'dark',
    available: true,
    access: ACCESS_FREE,
...
const DRESS_GROUP_DEFS = [
  ...
  },
  {
    ...
    upcoming: [
      ...
      ['cards-round', '软圆罐头卡', '卡片收成更圆的软边。'],
      ['cards-sharp', '方折罐头卡', '卡片收成直角折边。'],
      ['cards-wide', '宽影罐头卡', '卡片带更宽的浅阴影。'],
      ['cards-thin', '细边罐头卡', '卡片只留一圈细边。'],
