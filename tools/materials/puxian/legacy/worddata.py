"""Legacy Puxian word spreadsheet helper.

Historical reference only. This script assumes ``3.xls`` with old dictionary
column positions and writes ``target.xls`` in the current directory. Install
``tools/materials/requirements.txt`` before running manually.
"""

import xlrd
import xlwt

from tools.materials.puxian import romanization as translate
