"""Legacy Puxian Excel helper for restoring traditional forms.

Historical reference only. This script assumes local files named
``reference.xls`` and ``target.xls`` with old dictionary column positions.
