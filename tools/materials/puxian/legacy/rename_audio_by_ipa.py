"""Legacy Puxian audio filename migration helper.

Historical reference only. Importing/running this script renames ``../*.mp3``
files based on old Puxian IPA filename assumptions. Prefer
``tools.materials.puxian.romanization`` for pure conversion logic.
"""
