"""Legacy Puxian spreadsheet simplification helper.

Historical reference only. This script assumes ``target.xls`` with old
dictionary column positions and writes ``output.txt`` in the current directory.
